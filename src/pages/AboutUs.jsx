...
import Lautaro from "../assets/images/LautaroZarate.jpg";
import Nicolas from "../assets/images/NicolasKreisel.jpg";
import Paula from "../assets/images/PaulaRodriguez.jpg";
import Matias from "../assets/images/MatiasSoria.jpg";
import Nadia from "../assets/images/NadiaMedina.jpg";
import Pablo from "../assets/images/PabloTorres.png";
            ...
            >
              <Card.Body className="text-center">
                ...
                >
                  ...
                  que trabajamos juntos para crear la mejor experiencia musical
                  digital. Cada miembro aporta su expertise único para hacer de
                  DEVMusic una plataforma excepcional.
                </p>
              </Card.Body>
            </Card>
          </Col>
            ...
            <Card
              ...
              onMouseEnter={(e) => {
                ...
                e.currentTarget.style.boxShadow =
                  "0 8px 25px rgba(248, 149, 62, 0.5)";
                e.currentTarget.style.borderColor = "#EC773C";
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.transform = "translateY(0)";
                e.currentTarget.style.boxShadow =
                  "0 4px 15px rgba(248, 149, 62, 0.3)";
            ...
            >
              <Card.Body style={{ padding: "0.5rem" }}>
                ...
                >
                  ...
                  >
                    <strong style={{ color: "#EC773C" }}>Fecha:</strong>{" "}
                  ...
                  >
                    <strong style={{ color: "#EC773C" }}>Hora:</strong>{" "}
            ...
            <Col xs={12} lg={10} key={index} className="mb-4">
              <Card
                ...
                onMouseEnter={(e) => {
                  ...
                  e.currentTarget.style.boxShadow =
                    "0 12px 30px rgba(231, 108, 60, 0.5)";
                  e.currentTarget.style.borderColor = "#F8953E";
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.transform = visibleCards.has(index)
                    ? "translateY(0)"
                    : "translateY(30px)";
                  e.currentTarget.style.boxShadow =
                    "0 4px 20px rgba(231, 108, 60, 0.2)";
                      ...
                      <div style={{ display: "flex", gap: "1rem" }}>
                        <Button
                          ...
                          onMouseEnter={(e) => {
                            ...
                            e.target.style.boxShadow =
                              "0 4px 15px rgba(236, 119, 60, 0.4)";
                          }}
                          onMouseLeave={(e) => {
                        ...
                        <Link
                          ...
                          onMouseEnter={(e) => {
                            ...
                            e.target.style.transform = "translateY(-2px)";
                            e.target.style.boxShadow =
                              "0 4px 15px rgba(248, 149, 62, 0.4)";
                          }}
                          onMouseLeave={(e) => {
                            e.target.style.backgroundColor = "transparent";
